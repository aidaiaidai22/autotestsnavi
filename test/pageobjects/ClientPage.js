class ClientPage {
    ...
    get editEmail(){return $('input[placeholder="example@mail.ru"]')}
    get editBirth(){return $('input[placeholder="Дата рождения"]')}
    get editPhone(){return $('input[placeholder="Телефон"]')}
